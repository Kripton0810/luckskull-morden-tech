                                        ...
                                        <div class="card user-data-card bg-black">
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <div class="title d-flex align-items-center"><span>Demo ID</span>
                                                    </div>
                                                ...
                                                <div
                                                    class="single-profile-data d-flex align-items-center justify-content-between">
                                                    <div class="title d-flex align-items-center"><span>Demo
                                                            Password</span></div>
                                            ...
                                            <div class="card user-data-card bg-black">
                                                <div class="card-body">
                                                    <div
                                                        class="single-profile-data d-flex align-items-center justify-content-between">
                                                        <div class="title d-flex align-items-center"><span>Min
                                                                Bet</span></div>
